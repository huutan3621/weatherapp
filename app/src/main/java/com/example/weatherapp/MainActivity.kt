...
class MainActivity : AppCompatActivity() {
    //ho chi minh city longitude and latitude, API key
    val LAT: String = "10.8333"
    val LON: String = "106.6667"
    val API: String = "ff7dd10531073f7ee063f8a28de19ffc"
    ...
    inner class weatherTask() : AsyncTask<String, Void, String>(){
        ...
        override fun onPostExecute(result: String?) {
            ...
            try {
                ...
                /* insert data from api to the screen */
                ...
                /* Hide loader and show it in the screen */
